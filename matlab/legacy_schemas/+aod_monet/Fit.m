%{
aod_monet.Fit (computed) # fitting RFs for computing significance
-> aod_monet.CleanRF
-----
...
classdef Fit < dj.Relvar & dj.AutoPopulate
    ...
    properties
        popRel  = aod_monet.CleanRF;
    end
    
    methods(Access=protected)
        
        function makeTuples(self, key)
            [width,height] = fetch1(aod_monet.RF & key, 'degrees_x', 'degrees_y');
            map = fetch1(aod_monet.CleanRF & key, 'clean_map');
