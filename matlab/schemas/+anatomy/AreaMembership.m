            ...
            for field_key = field_keys'
                ...
                if strcmp(setup,'2P4')
                    [px_width, px_height, keys] = ...
                        ...
                        proj(meso.ScanInfoField & fuse.ScanSet &  (fuse.ScanSetUnit & field_key),'px_height','px_width'),...
                        'px_x','px_y');
                else
                    [px_width, px_height, keys] = ...
                        fetchn((reso.ScanSetUnitInfo & (fuse.ScanSetUnit & field_key)) * ...
                        proj(reso.ScanInfo & fuse.ScanSet &  (fuse.ScanSetUnit & field_key),'px_height','px_width'),...
                        'px_x','px_y');
                end
