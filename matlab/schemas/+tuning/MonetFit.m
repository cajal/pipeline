%{
tuning.MonetFit (computed) # fitting RFs for computing significance
-> tuning.MonetCleanRF
-----
...
classdef MonetFit < dj.Relvar & dj.AutoPopulate
    
    properties
        popRel  = tuning.MonetCleanRF;
    end
    
    methods(Access=protected)
        
        function makeTuples(self, key)
            [width,height] = fetch1(tuning.MonetRF & key, 'degrees_x', 'degrees_y');
            map = fetch1(tuning.MonetCleanRF & key, 'clean_map');
