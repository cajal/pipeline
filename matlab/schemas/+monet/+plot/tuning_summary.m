...
von = monet.VonMises & 'segment_method=2' & 'spike_inference=2';
keys = fetch(pro(common.Animal, rf.Session, 'max(session_date)->sess_date') & monet.VonMises, 'sess_date', 'ORDER BY sess_date DESC');
